      ...
      if (importData.name && !importData.agents) {
        if (selectedAgents.includes(0)) {
          await onImport({
            ...
            system_prompt: importData.system_prompt || null,
            bio: importData.bio || null,
            lore: importData.lore || null,
            message_examples: importData.message_examples || null,
            post_examples: importData.post_examples || null,
            adjectives: importData.adjectives || null,
            topics: importData.topics || null,
            style_config: importData.style_config || null,
      ...
      if (importData.agents) {
        for (const [index, agent] of importData.agents.entries()) {
          ...
          await onImport({
            ...
            message_examples: agent.message_examples || null,
            post_examples: agent.post_examples || null,
            adjectives: agent.adjectives || null,
            topics: agent.topics || null,
            style_config: agent.style_config || null,
            enabled: agent.enabled !== false
          });
        }
      }
      
      // Success - clear import data and close modal
      setImportData(null);
      setSelectedAgents([]);
      onClose();
    } catch (err) {
